    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<long>(type: "bigint", nullable: false),
                    TeaWeight = table.Column<int>(type: "integer", nullable: true),
                    TeaForm = table.Column<int>(type: "integer", nullable: true),
                    TeaType = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
