...
public class EditTeaDescriptionTextCommand : BaseTextCommand
{
    ...
    public EditTeaDescriptionTextCommand(IMemoryCachService memoryCachService, IUpdateTeaCommand updateTeaCommand,
    ...
    public override string Name => "editTeaDescription";
        ...
        if (update.Message != null && update.Message.Text != null)
        {
            ...
            if (!_textCommandService.CheckMessageIsCommand(messageText))
            {
                try
                {
                    ...
                    tea.Description = messageText;

                    await _updateTeaCommand.UpdateTeaDescriptionAsync(tea.Adapt<Tea>());
